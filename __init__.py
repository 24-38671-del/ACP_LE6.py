...
def create_app(config_class=Config):
    ...
    db.init_app(app) # <-- REMOVED THE EXTRA '=' SIGN HERE
    migrate.init_app(app, db) # Ensure Migrate is initialized too!
    
    # Register blueprints (route collections)
    # Corrected import path: using a relative import (from .)
